...
def read_settings_sql():
    ...
    return trading_on, start, part, fee, profit_fee_coef, trade_move_coef

def sql_trading_settings_write(local_time, trading_on, start, part, fee, profit_fee_coef, trade_move_coef):

...
RANDOM, WINDOW, FEATURES_LENGTH, BATCH_SIZE, EPOCH, FEE, SLIP_N = config_model()
...
def create_labels(df):
    ...
    return df[['bnb_btc_min', 'bnb_btc_max', 'bnb_btc_min_max',
               'eth_btc_min', 'eth_btc_max', 'eth_btc_min_max',
               'bnb_eth_min', 'bnb_eth_max', 'bnb_eth_min_max',
               'not_buy', 'label']]
